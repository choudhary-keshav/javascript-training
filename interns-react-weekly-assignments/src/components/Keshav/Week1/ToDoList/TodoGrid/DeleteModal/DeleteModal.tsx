  ...
  return (
    <DeleteModalWrapper>
        ...
        <div className="deleteModalContainer">
            <span onClick={closeDeleteModal} className="cross">X</span>
            <h2>Do you really want to delete the item from ToDo List?</h2>
            <br /><br />
            <div className="buttons">
                <button onClick={closeDeleteModal} className="button">No</button>
                <button onClick={deleteTask} className="button">Yes</button>
            </div>
        </div>
    </DeleteModalWrapper>
  )
